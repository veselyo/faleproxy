...
describe('Yale to Fale replacement logic', () => {
  ...
  test('should handle text that has no Yale references', () => {
    const htmlWithoutYale = `
      ...
      <body>
        <h1>Hello World</h1>
        <p>This is a test page with no references to the Harvard backup school.</p>
      </body>
      </html>
    `;
    ...
    expect(modifiedHtml).toContain('<p>This is a test page with no references to the Harvard backup school.</p>');
  });
